...
class MarketResearchService:
    ...
    async def _fetch_awards_for_labor(
        ...
        if location:
            # Map common state names to abbreviations for USASpending API
            state_map = {
                ...
                "wisconsin": "WI", "wyoming": "WY", "washington dc": "DC", "dc": "DC",
            }
            loc = location.strip()
            state_code = state_map.get(loc.lower(), loc.upper()[:2])
